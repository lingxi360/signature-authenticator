...
class AuthenticatorTest extends PHPUnit_Framework_TestCase
{
    ...
    /**
     * @expectedException \Rry\SignatureAuthenticator\Exceptions\SignatureValueException
     */
    ...
    public function test_it_can_get_auth_parameters_and_verify_success()
    {
        ...
        $parameters = $this->authenticator->getAuthParameters($this->data);

        $this->assertTrue($this->authenticator->attempt($parameters));
    }
